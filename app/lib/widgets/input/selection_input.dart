...
import 'package:app/widgets/input/input.dart';
import 'package:common_components/common_components.dart';
import 'package:flutter/material.dart';

/// {@template selection_input} This class provides a simple implementation of
/// a input with an optional title and a list of selectionale options.
      ...
      child: Material(
        child: ConstrainedBox(
          constraints: BoxConstraints(
            ...
            // the tree there are instrinsic constraints.
            maxWidth: MediaQuery.sizeOf(context).width - 4 * $styles.insets.sm,
          ),
          child: Column(
            children: [
              Padding(
